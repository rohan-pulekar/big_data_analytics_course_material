...
public class LogAggregatorFirst extends Configured implements Tool { 
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(LogAggregatorFirst.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new LogAggregatorFirst(),
				args);
		System.exit(res);
	} 
